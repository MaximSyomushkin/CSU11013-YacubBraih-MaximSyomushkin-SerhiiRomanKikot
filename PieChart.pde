/*
    ...
    Pie chart widget for visualizing labeled numeric data
*/
class PieChart extends Widget {
    ...
    // Initializes pie chart data, geometry, and generated colors
    ...
    // Generates random color for each chart segment
    ...
    // Calculates total value and label layout per column
    ...
    // Replaces chart data and rebuilds colors/totals
    ...
    // Draws pie slices, legend labels, and chart title
    void drawWidget() {
        fill(255);
